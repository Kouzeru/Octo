...
function playPattern(soundLength,buffer,remainingTime=0,
	pitch=PITCH_BIAS,sampleState={"pos":0,"pole1":0,"pole2":0}) {
	...
	return {"pos":(pos-samplesBack)%bufflen,"pole1":pole1,"pole2":pole2}
}
...
function AudioControl(){
	...
	this.refresh = _ => {
		...
		else this.state = playPattern(_,this.buffer,0,this.pitch,this.state);
